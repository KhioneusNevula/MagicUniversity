...
Maybe theta-roles? I.e. who is the agent, experiencer, patient, or theme? For better organization?
...
Memories also can be formed with causal links, i.e. relations that indicate what other memory caused this memory. This can be to denote events caused by other events, e.g. [Max died] -:CAUSE:-> [John killed Max]; or it can denote simply that a memory was generated by a feeling produced by another memory, e.g. [Thoughts of attraction to John] -:CAUSE:-> [John did complimenting to me], as a result of the Character thinking about [John did complimenting to me], feeling happiness, happiness motivating a thought of attraction. 
